...
<?php endforeach; ?>
            ...
            <div class="db-actions-row">
                <a href="/admin/post-manager.php" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Add New Post
                </a>
                <a href="/admin/blogs-manager.php" class="btn btn-secondary">
            ...
            <div class="db-card" data-widget="traffic">
                <div class="db-card-head">
                    ...
                    <a href="/admin/analytics.php" class="db-card-link">View Full Analytics <i class="fas fa-arrow-right"></i></a>
                </div>
            ...
            <div class="db-card" data-widget="todaysposts">
                <div class="db-card-head">
                    ...
                    <a href="/admin/blogs-manager.php" class="db-card-link">All Posts <i class="fas fa-arrow-right"></i></a>
                </div>
                <div class="db-card-body">
            ...
            <div class="btn-grid" style="margin-bottom: 1.5rem;">
                <a href="/admin/post-manager.php" class="action-btn">
                ...
                <a href="/admin/blogs-manager.php" class="action-btn">
                ...
                <a href="/admin/comments-manager.php" class="action-btn">
               ...
               <?php if (!empty($permissions['blogs']['manage_tags'])): ?>
                <a href="/admin/tag-manager.php" class="action-btn">
                ...
                <a href="/admin/categories-manager.php" class="action-btn">
