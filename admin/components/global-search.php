...
.gsearch-icon { position: absolute; left: 12px; top: 50%; transform: translateY(-50%); color: var(--gray-400, #9ca3af); font-size: 0.85rem; }
.gsearch-input { width: 100%; padding: 0.55rem 0.75rem 0.55rem 2.1rem; border: 1px solid var(--gray-200, #e5e7eb); border-radius: 999px; font-size: 0.875rem; background: var(--gray-50, #f9fafb); transition: all 0.15s; }
.gsearch-input:focus { outline: none; border-color: var(--primary, #7c3aed); background: #fff; box-shadow: 0 0 0 3px var(--primary-lighter, #f5f3ff); }
